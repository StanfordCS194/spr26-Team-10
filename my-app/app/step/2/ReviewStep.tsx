  ...
  useEffect(() => {
    ...
    const id = window.setInterval(async () => {
      ...
      try {
        ...
        console.log("[poll] next fields length:", next.length);
      ...
      <PageSplit
        ...
        right={
          <div className={reviewStyles.rightInner}>
            ...
            {extracting ? (
              <ExtractionSpinner label={rv.extracting} />
            ) : (
            <>
                  ...
                  >
                    ...
                    <div className={reviewStyles.fieldActions}>
                      <button
                        ...
                        aria-label={isConfirmed ? rv.cancel : rv.confirmAll}
                        title={rv.looksCorrect}
                        disabled={isEditing}
                      >
                        <IconCheck size={13} aria-hidden />
                      </button>
                      <button
                        ...
                        aria-label={isEditing ? rv.cancel : rv.fixThis}
                        title={isEditing ? rv.cancel : rv.fixThis}
                      >
